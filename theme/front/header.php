...
<div class="navigation" style="background:#fff;border-bottom:1px solid #00aac6;height:100px;">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 col-xs-12 pull-right">	
				<ul class="box-lanrenzhijia" id="box-lanrenzhijia">
				   ...
				   <li style="width:120px;margin-right:0px;text-align:right;">
				   	<?php if($this->session->userdata('uid')){?>
				   <a href="<?php echo site_url('usercenter/index');?>" class="start">
				   <?php }else{ ?>
				   <a href="<?php echo site_url('welcome/register_frame');?>" class="start">
				   <?php } ?>
